...
Public Class viewissuedoctype
    ...
    Private Sub viewissuedoctype_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Public Sub Load_Handover_Docs()
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select COUNT(doctype) AS 'Total', doctype from archival_issuance where [returnedby] IS NULL group by doctype"
            con.Open()
            ...
            While dr.Read
                ...
                pic.Text = dr.Item("doctype").ToString + Environment.NewLine + dr.Item("Total").ToString
    ...
    Private Sub View_Handover_Catogery(sender As Object, e As EventArgs)
        ...
        Dim formaaa As New viewissuedoccatogery
    ...
    Private Sub GunaGradientButton3_Click(sender As Object, e As EventArgs) Handles GunaGradientButton3.Click
        ' Dim form As New issuancecalender
        ' Form.ShowDialog()
    End Sub
