...
Public Class esignhandoverfromdataupload

    Dim cmd As SqlCommand
    Dim cmd1 As SqlCommand
    Dim cmd2 As SqlCommand
    Dim cmd3 As SqlCommand
    Private Sub esignhandoverfromdataupload_Load(sender As Object, e As EventArgs) Handles MyBase.Load
                    ...
                    ElseIf userstatus = "Active" Or userstatus = "esign" Then
                        ...
                        ElseIf password = TextBox2.Text Then
                            Try
                                ...
                                Dim f1 As uploaddata = DirectCast(Me.Owner, uploaddata)
                                f1.Label3.Text = fullname
