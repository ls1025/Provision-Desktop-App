...
Public Class esigndoccorrection

    Dim cmd As SqlCommand
    Dim cmd1 As SqlCommand
    Dim cmd2 As SqlCommand
    Dim cmd3 As SqlCommand
    Private Sub esigndoccorrection_Load(sender As Object, e As EventArgs) Handles MyBase.Load
                    ...
                    ElseIf userstatus = "Active" Or userstatus = "esign" Then
                        ...
                        ElseIf password = TextBox2.Text Then
                            Try
                                ...
                                Dim f1 As returnforcorrections = DirectCast(Me.Owner, returnforcorrections)
                                f1.GunaLabel1.Text = fullname
                                Me.Close()
