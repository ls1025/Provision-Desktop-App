...
Public Class changepwfrdgl
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Dim cmd As New SqlCommand("update users set [status]='Active', [password]='" + TextBox2.Text + "' where fullname='" + Homepagefrdgl.Label1.Text + "'", con)
            con.Open()
            cmd.ExecuteNonQuery()
            con.Close()
