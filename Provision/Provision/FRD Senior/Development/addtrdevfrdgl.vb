...
Public Class addtrdevfrdgl
    ...
    Private Sub Loadtest()
        Try
            ...
            Dim cmd As New SqlCommand
            cmd.Connection = con
            cmd.CommandText = "select test from testmaster order by test ASC"
            con.Open()
            Dim dr As SqlDataReader = cmd.ExecuteReader
            While dr.Read
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            ElseIf GunaTextBox2.Text = "" Then
                MsgBox("Select Expiry date, Tick NA if Not Applicable", vbCritical)
    ...
    Private Sub firsttest()
        ...
        If String.IsNullOrEmpty(a) Then
            a = "DT/" + LastString_Year + "/0001"
            'TextBox1.Text = result
        ElseIf a.Length = 10 Then
            a = a.Substring(6)
            Int32.TryParse(a, curValue)
            curValue = curValue + 1
            a = "DT/" + LastString_Year + "/" + curValue.ToString("D4")
            'TextBox1.Text = result
        ElseIf a.Length > 10 Then
