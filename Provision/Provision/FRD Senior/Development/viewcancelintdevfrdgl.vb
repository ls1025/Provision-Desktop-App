...
Public Class viewcancelintdevfrdgl
    ...
    Private Sub GunaGradientButton1_Click(sender As Object, e As EventArgs) Handles GunaGradientButton1.Click
        Dim form As New newcancelreqdevfrdgl
        form.Owner = Me
        form.ShowDialog()
    End Sub
    ...
    Private Sub viewcancelintdevfrdgl_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
            ...
            For i As Integer = 0 To DataGridView1.Rows.Count() - 1
                ...
                If check = True Then
                    ...
                    Else
                        ...
                        cmd1.Connection = con
                        cmd1.CommandText = "update trdev set creqstatus='Approved',Status='Cancelled',cancelledby='" + Homepagefrdgl.Label1.Text + "',cancelleddate=@cancelleddate where trno='" + DataGridView1.Rows(i).Cells(2).Value + "'"
            ...
            For i As Integer = 0 To DataGridView1.Rows.Count() - 1
                ...
                If check = True Then
                    ...
                    Else
                        ...
                        Dim cmd1 As New SqlCommand
                        cmd1.Connection = con
                        cmd1.CommandText = "update trdev set creqstatus='Rejected',creqrejectedby='" + Homepagefrdgl.Label1.Text + "',creqrejectedon=@creqrejectedon where trno='" + DataGridView1.Rows(i).Cells(2).Value + "'"
