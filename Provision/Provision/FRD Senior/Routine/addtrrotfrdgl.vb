...
Public Class addtrrotfrdgl
    Dim da As New SqlDataAdapter()
    Private Sub addtrrotfrdgl_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub firsttest()
        ...
        con.Open()
        Dim cmd = New SqlCommand("Select MAX(trno) FROM trrot", con)
        ...
        If String.IsNullOrEmpty(a) Then
            a = "TR/" + LastString_Year + "/0001"
            'TextBox1.Text = result
        ElseIf a.Length = 10 Then
            a = a.Substring(6)
            Int32.TryParse(a, curValue)
            curValue = curValue + 1
            a = "TR/" + LastString_Year + "/" + curValue.ToString("D4")
            'TextBox1.Text = result
        ElseIf a.Length > 10 Then
        ...
        cmd1.Connection = con
        cmd1.CommandText = "insert into trrot (productcode,productname,strength,market,trno,label,btn,btsize,mfgdate,expdate,sampleqty,pack,cndn,period,test,testdetails,remarks,reportingto,requestedby,requestdate,Status) values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + a + "','" + TextBox10.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + GunaTextBox1.Text + "','" + GunaTextBox2.Text + "','" + TextBox11.Text + "','" + TextBox7.Text + "','" + ComboBox1.Text + "','" + TextBox8.Text + "','" + ComboBox3.Text + "','" + TextBox9.Text + "','" + TextBox12.Text + "','" + reportername + "','" + Homepagefrdgl.Label1.Text + "',@requestdate,'New TR')"
    ...
    Private Sub secondtest()
        ...
        Dim cmd1 As New SqlCommand
        cmd1.Connection = con
        cmd1.CommandText = "insert into trrot (productcode,productname,strength,market,trno,label,btn,btsize,mfgdate,expdate,sampleqty,pack,cndn,period,test,testdetails,remarks,reportingto,requestedby,requestdate,Status) values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + a + "','" + TextBox14.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + GunaTextBox1.Text + "','" + GunaTextBox2.Text + "','" + TextBox15.Text + "','" + TextBox7.Text + "','" + ComboBox1.Text + "','" + TextBox8.Text + "','" + ComboBox4.Text + "','" + TextBox13.Text + "','" + TextBox16.Text + "','" + reportername + "','" + Homepagefrdgl.Label1.Text + "',@requestdate,'New TR')"
        cmd1.Parameters.AddWithValue("@requestdate", SqlDbType.Date).Value = DateTime.Now.Date
        con.Open()
        cmd1.ExecuteNonQuery()
        con.Close()
    ...
    Private Sub thirdtest()
        ...
        Dim cmd1 As New SqlCommand
        cmd1.Connection = con
        cmd1.CommandText = "insert into trrot (productcode,productname,strength,market,trno,label,btn,btsize,mfgdate,expdate,sampleqty,pack,cndn,period,test,testdetails,remarks,reportingto,requestedby,requestdate,Status) values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + a + "','" + TextBox18.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + GunaTextBox1.Text + "','" + GunaTextBox2.Text + "','" + TextBox19.Text + "','" + TextBox7.Text + "','" + ComboBox1.Text + "','" + TextBox8.Text + "','" + ComboBox5.Text + "','" + TextBox17.Text + "','" + TextBox20.Text + "','" + reportername + "','" + Homepagefrdgl.Label1.Text + "',@requestdate,'New TR')"
        cmd1.Parameters.AddWithValue("@requestdate", SqlDbType.Date).Value = DateTime.Now.Date
        con.Open()
        cmd1.ExecuteNonQuery()
        con.Close()
    ...
    Private Sub fourthtest()
        ...
        Dim cmd1 As New SqlCommand
        cmd1.Connection = con
        cmd1.CommandText = "insert into trrot (productcode,productname,strength,market,trno,label,btn,btsize,mfgdate,expdate,sampleqty,pack,cndn,period,test,testdetails,remarks,reportingto,requestedby,requestdate,Status) values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + a + "','" + TextBox22.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + GunaTextBox1.Text + "','" + GunaTextBox2.Text + "','" + TextBox23.Text + "','" + TextBox7.Text + "','" + ComboBox1.Text + "','" + TextBox8.Text + "','" + ComboBox6.Text + "','" + TextBox21.Text + "','" + TextBox24.Text + "','" + reportername + "','" + Homepagefrdgl.Label1.Text + "',@requestdate,'New TR')"
        cmd1.Parameters.AddWithValue("@requestdate", SqlDbType.Date).Value = DateTime.Now.Date
        con.Open()
        cmd1.ExecuteNonQuery()
        con.Close()
    ...
    Private Sub fifthtest()
        ...
        Dim cmd1 As New SqlCommand
        cmd1.Connection = con
        cmd1.CommandText = "insert into trrot (productcode,productname,strength,market,trno,label,btn,btsize,mfgdate,expdate,sampleqty,pack,cndn,period,test,testdetails,remarks,reportingto,requestedby,requestdate,Status) values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + a + "','" + TextBox26.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + GunaTextBox1.Text + "','" + GunaTextBox2.Text + "','" + TextBox27.Text + "','" + TextBox7.Text + "','" + ComboBox1.Text + "','" + TextBox8.Text + "','" + ComboBox7.Text + "','" + TextBox25.Text + "','" + TextBox28.Text + "','" + reportername + "','" + Homepagefrdgl.Label1.Text + "',@requestdate,'New TR')"
        cmd1.Parameters.AddWithValue("@requestdate", SqlDbType.Date).Value = DateTime.Now.Date
        con.Open()
        cmd1.ExecuteNonQuery()
        con.Close()
    ...
    Private Sub sixthtest()
        ...
        Dim cmd1 As New SqlCommand
        cmd1.Connection = con
        cmd1.CommandText = "insert into trrot (productcode,productname,strength,market,trno,label,btn,btsize,mfgdate,expdate,sampleqty,pack,cndn,period,test,testdetails,remarks,reportingto,requestedby,requestdate,Status) values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + a + "','" + TextBox30.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + GunaTextBox1.Text + "','" + GunaTextBox2.Text + "','" + TextBox31.Text + "','" + TextBox7.Text + "','" + ComboBox1.Text + "','" + TextBox8.Text + "','" + ComboBox8.Text + "','" + TextBox29.Text + "','" + TextBox32.Text + "','" + reportername + "','" + Homepagefrdgl.Label1.Text + "',@requestdate,'New TR')"
        cmd1.Parameters.AddWithValue("@requestdate", SqlDbType.Date).Value = DateTime.Now.Date
        con.Open()
        cmd1.ExecuteNonQuery()
        con.Close()
    ...
    Private Sub GetGroupleadername()
        Try
            ...
            con.Open()
            Dim qry As String
            qry = "select * from users where fullname='" + Homepagefrdgl.Label1.Text + "'"
            cmd = New SqlCommand(qry, con)
            Dim da As SqlDataAdapter = New SqlDataAdapter(cmd)
            Dim table As New DataTable()
            da.Fill(table)
    ...
    Private Sub PrintDocument1_PrintPage(sender As System.Object, e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        Try
            ...
            e.Graphics.DrawString(TextBox5.Text, ReportFont5, Brushes.Black, New System.Drawing.Rectangle(100, 295, 100, 30), StringFormat)
            ...
            e.Graphics.DrawString(TextBox7.Text, ReportFont5, Brushes.Black, 325, 342)
            ...
            e.Graphics.DrawString(TextBox8.Text, ReportFont5, Brushes.Black, 335, 381)
            ...
            e.Graphics.DrawString(Homepagefrdgl.Label1.Text, ReportFont5, Brushes.Black, 90, 550)
