...
Public Class releasedatalnb
    ...
    Private Sub releasedatalnb_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        loadTRs()
    ...
    Private Sub loadTRs()
        Try
            ...
            con.Open()
            Dim qry As String
            qry = "select (trno) from trdev where [productname]='" + TextBox1.Text + "' and [test]='" + TextBox2.Text + "' and [lnbno]='" + TextBox3.Text + "' and Status='Data Sent to DQA' and atrno='NA' union select (trno) from trrot where [productname]='" + TextBox1.Text + "' and [test]='" + TextBox2.Text + "' and [lnbno]='" + TextBox3.Text + "' and Status='Data Sent to DQA' and atrno='NA' union select (trno) from trstb where [productname]='" + TextBox1.Text + "' and [test]='" + TextBox2.Text + "' and [lnbno]='" + TextBox3.Text + "' and Status='Data Sent to DQA' and atrno='NA'"
            ...
            If result = DialogResult.Yes Then
                For i As Integer = 0 To CheckedListBox1.CheckedItems.Count - 1
                    ...
                    Try
                        ...
                        Dim f1 As datafromardlnb = DirectCast(Me.Owner, datafromardlnb)
                        f1.LoadLNB()
                        Me.Close()
