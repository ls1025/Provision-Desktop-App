...
Public Class viewstpdetails
    Private Sub viewstpdetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadTestDetails()
    ...
    Private Sub DataGridView1_CellContentClick(sender As System.Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        If TypeOf senderGrid.Columns(e.ColumnIndex) Is DataGridViewButtonColumn AndAlso e.RowIndex >= 0 Then
            ...
            ElseIf e.ColumnIndex = 1 Then
                ...
                If DataGridView1.Rows(e.RowIndex).Cells(4).Value.ToString() = "" Then
                    form.TextBox3.Text = "STP/"
                    form.TextBox3.ReadOnly = False
                ElseIf DataGridView1.Rows(e.RowIndex).Cells(4).Value.ToString() = "NA" Then
