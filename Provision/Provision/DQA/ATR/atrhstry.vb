...
Imports System.IO
Public Class atrhstry
    Private Sub atrhstry_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If TypeOf senderGrid.Columns(e.ColumnIndex) Is DataGridViewButtonColumn AndAlso e.RowIndex >= 0 Then
            ...
            If e.ColumnIndex = 0 Then
                Try
                    If con.State = ConnectionState.Open Then con.Close()
                    Dim qry1 As String
                    qry1 = "select atrfile from atrhstry where atrno='" + Label4.Text + "' and atrversion='" + DataGridView1.Rows(e.RowIndex).Cells(2).Value.ToString() + "'"
