...
Public Class viewcancelintstb
    ...
    Private Sub GunaGradientButton1_Click(sender As Object, e As EventArgs) Handles GunaGradientButton1.Click
        Dim form As New newcancelreqstb
        form.Owner = Me
        form.ShowDialog()
    End Sub
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        ElseIf ComboBox3.Text = "Cancell Request" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[trno],[creqby],[creqdate],[cancelleddate],[creqstatus] from trstb where creqby is NOT NULL and requestdate between @fromdate and @todate order by [creqdate] DESC")
                cmd.Connection = con
        ...
        ElseIf ComboBox3.Text = "Cancelled" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[trno],[creqby],[creqdate],[cancelledby],[cancelleddate],[creqstatus] from trstb where creqby is NOT NULL and cancelleddate between @fromdate and @todate order by [creqdate] DESC")
                cmd.Connection = con
                cmd.Parameters.AddWithValue("@fromdate", SqlDbType.Date).Value = DateTimePicker1.Value.Date
                cmd.Parameters.AddWithValue("@todate", SqlDbType.Date).Value = DateTimePicker2.Value.Date
                Dim adapter1 As New SqlDataAdapter(cmd)
    ...
    Private Sub viewcancelintstb_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
