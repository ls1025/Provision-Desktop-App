...
Imports iTextSharp
Imports System.IO
Public Class viewatrissued
    Dim da As New SqlDataAdapter()

    Private Sub viewatrissued_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub LoadProductNameDev()
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select DISTINCT(productname) from trdev where Status='ATR Issued' union select DISTINCT(productname) from trrot where Status='ATR Issued' union select DISTINCT(productname) from trstb where Status='ATR Issued' order by [productname] ASC"
            con.Open()
    ...
    Private Sub LoadTestDev()
        Try
            ...
            Dim cmd As New SqlCommand
            cmd.Connection = con
            cmd.CommandText = "select DISTINCT(test) from trdev where Status='ATR Issued' union select DISTINCT(test) from trrot where Status='ATR Issued' union select DISTINCT(test) from trstb where Status='ATR Issued' order by [test] ASC"
            con.Open()
            Dim dr As SqlDataReader = cmd.ExecuteReader
            While dr.Read
    ...
    Public Sub LoadATRDetails()
        ...
        cmd2.Connection = con
        cmd2.CommandText = "select [productname],[test],[atrissueno] from trdev where Status='ATR Issued' group by [productname],[test],[atrissueno] union select [productname],[test],[atrissueno] from trrot where Status='ATR Issued' group by [productname],[test],[atrissueno] union select [productname],[test],[atrissueno] from trstb where Status='ATR Issued' group by [productname],[test],[atrissueno]"
    ...
    Private Sub Filterdata1(ValueTosearch As String)
        Try
            If con.State = ConnectionState.Open Then con.Close()
            Dim cmd As New SqlCommand("select [productname],[test],[atrissueno] from trdev where Status='ATR Issued' and ([atrissueno] like '%" & ValueTosearch & "%' or [productcode] like '%" & ValueTosearch & "%' or [btn] like '%" & ValueTosearch & "%') group by [productname],[test],[atrissueno] union select [productname],[test],[atrissueno] from trrot where Status='ATR Issued' and ([atrissueno] like '%" & ValueTosearch & "%' or [productcode] like '%" & ValueTosearch & "%' or [btn] like '%" & ValueTosearch & "%') group by [productname],[test],[atrissueno] union select [productname],[test],[atrissueno] from trstb where Status='ATR Issued' and ([atrissueno] like '%" & ValueTosearch & "%' or [productcode] like '%" & ValueTosearch & "%' or [btn] like '%" & ValueTosearch & "%') group by [productname],[test],[atrissueno]")
            cmd.Connection = con
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Try
            If ComboBox2.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [productname],[test],[atrissueno] from trdev where Status='ATR Issued' and [productname] = '" + ComboBox1.Text + "' group by [productname],[test],[atrissueno] union select [productname],[test],[atrissueno] from trrot where Status='ATR Issued' and [productname] = '" + ComboBox1.Text + "' group by [productname],[test],[atrissueno] union select [productname],[test],[atrissueno] from trstb where Status='ATR Issued' and [productname] = '" + ComboBox1.Text + "' group by [productname],[test],[atrissueno]")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox2.Text <> "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [productname],[test],[atrissueno] from trdev where Status='ATR Issued' and [productname] = '" + ComboBox1.Text + "' and [test]='" + ComboBox2.Text + "' group by [productname],[test],[atrissueno] union select [productname],[test],[atrissueno] from trrot where Status='ATR Issued' and [productname] = '" + ComboBox1.Text + "' and [test]='" + ComboBox2.Text + "' group by [productname],[test],[atrissueno] union select [productname],[test],[atrissueno] from trstb where Status='ATR Issued' and [productname] = '" + ComboBox1.Text + "' and [test]='" + ComboBox2.Text + "' group by [productname],[test],[atrissueno]")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub ComboBox2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox2.SelectedIndexChanged
        ...
        Try
            If ComboBox1.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [productname],[test],[atrissueno] from trdev where Status='ATR Issued' and [test] = '" + ComboBox2.Text + "' group by [productname],[test],[atrissueno] union select [productname],[test],[atrissueno] from trrot where Status='ATR Issued' and [test] = '" + ComboBox2.Text + "' group by [productname],[test],[atrissueno] union select [productname],[test],[atrissueno] from trstb where Status='ATR Issued' and [test] = '" + ComboBox2.Text + "' group by [productname],[test],[atrissueno]")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        ElseIf ComboBox3.Text = "Intimation" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [productname],[test],[atrissueno] from trdev where Status='ATR Issued' and requestdate between @fromdate and @todate group by [productname],[test],[atrissueno] union select [productname],[test],[atrissueno] from trrot where Status='ATR Issued' and requestdate between @fromdate and @todate group by [productname],[test],[atrissueno] union select [productname],[test],[atrissueno] from trstb where Status='ATR Issued' and requestdate between @fromdate and @todate group by [productname],[test],[atrissueno] ")
                cmd.Connection = con
