...
Imports iTextSharp
Imports System.IO
Public Class newintimationarddev
    Dim da As New SqlDataAdapter()

    Private Sub newintimationarddev_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub LoadProductNameDev()
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select DISTINCT(productname) from trdev where (Status='New TR' or Status='TR Printed') union select DISTINCT(productname) from trrot where (Status='New TR' or Status='TR Printed') union select DISTINCT(productname) from trstb where (Status='New TR' or Status='TR Printed') order by [productname] ASC"
            con.Open()
    ...
    Private Sub LoadTestDev()
        Try
            ...
            Dim cmd As New SqlCommand
            cmd.Connection = con
            cmd.CommandText = "select DISTINCT(test) from trdev where (Status='New TR' or Status='TR Printed') union select DISTINCT(test) from trrot where (Status='New TR' or Status='TR Printed') union select DISTINCT(test) from trstb where (Status='New TR' or Status='TR Printed') order by [test] ASC"
            con.Open()
            Dim dr As SqlDataReader = cmd.ExecuteReader
            While dr.Read
    ...
    Public Sub LoadIntimationDev()
        ...
        cmd2.Connection = con
        cmd2.CommandText = "select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trdev where (Status='New TR' or Status='TR Printed') union select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trrot where (Status='New TR' or Status='TR Printed') union select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trstb where (Status='New TR' or Status='TR Printed') order by [trno] DESC"
    ...
    Private Sub GunaGradientButton2_Click(sender As Object, e As EventArgs) Handles GunaGradientButton2.Click
        ...
        Else
            ...
            ' Else
            'gBox("Not allowed more than 10", vbCritical)
    ...
    Private Sub Filterdata1(ValueTosearch As String)
        Try
            If con.State = ConnectionState.Open Then con.Close()
            Dim cmd As New SqlCommand("Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trdev where (Status='New TR' or Status='TR Printed') and ([productcode] like '%" & ValueTosearch & "%' or [btn] like '%" & ValueTosearch & "%') union Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trrot where (Status='New TR' or Status='TR Printed') and ([productcode] like '%" & ValueTosearch & "%' or [btn] like '%" & ValueTosearch & "%') union Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trstb where (Status='New TR' or Status='TR Printed') and ([productcode] like '%" & ValueTosearch & "%' or [btn] like '%" & ValueTosearch & "%')")
            cmd.Connection = con
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Try
            If ComboBox2.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trdev where (Status='New TR' or Status='TR Printed') and [productname] = '" + ComboBox1.Text + "' union Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trrot where (Status='New TR' or Status='TR Printed') and [productname] = '" + ComboBox1.Text + "' union Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trstb where (Status='New TR' or Status='TR Printed') and [productname] = '" + ComboBox1.Text + "' order by [trno] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox2.Text <> "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trdev where (Status='New TR' or Status='TR Printed') and [productname] = '" + ComboBox1.Text + "' and [test]='" + ComboBox2.Text + "' union Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trrot where (Status='New TR' or Status='TR Printed') and [productname] = '" + ComboBox1.Text + "' and [test]='" + ComboBox2.Text + "' union Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trstb where (Status='New TR' or Status='TR Printed') and [productname] = '" + ComboBox1.Text + "' and [test]='" + ComboBox2.Text + "' order by [trno] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub ComboBox2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox2.SelectedIndexChanged
        ...
        Try
            If ComboBox1.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trdev where (Status='New TR' or Status='TR Printed') and [test] = '" + ComboBox2.Text + "' union Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trrot where (Status='New TR' or Status='TR Printed') and [test] = '" + ComboBox2.Text + "' union Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trstb where (Status='New TR' or Status='TR Printed') and [test] = '" + ComboBox2.Text + "' order by [trno] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        ElseIf ComboBox3.Text = "Intimation" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trdev where (Status='New TR' or Status='TR Printed') and requestdate between @fromdate and @todate union Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trrot where (Status='New TR' or Status='TR Printed') and requestdate between @fromdate and @todate union Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trstb where (Status='New TR' or Status='TR Printed') and requestdate between @fromdate and @todate order by [trno] DESC")
                cmd.Connection = con
    ...
    Private Sub GunaComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox4.SelectedIndexChanged
        ...
        If ComboBox4.Text = "Development" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trdev where (Status='New TR' or Status='TR Printed') order by [trno] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
        ...
        ElseIf ComboBox4.Text = "Routine" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trrot where (Status='New TR' or Status='TR Printed') order by [trno] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
        ...
        ElseIf ComboBox4.Text = "Stability" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[productname],[test],[trno],[requestedby],[requestdate],[Status] from trstb where (Status='New TR' or Status='TR Printed') order by [trno] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
