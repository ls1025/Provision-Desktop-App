...
Public Class viewtrstatusfrdj
    ...
    Private Sub LoadProductNameDev()
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select DISTINCT(productname) from trdev where requestedby='" + Homepagefrdj.Label1.Text + "' union select DISTINCT(productname) from trrot where requestedby='" + Homepagefrdj.Label1.Text + "' union select DISTINCT(productname) from trstb where requestedby='" + Homepagefrdj.Label1.Text + "' order by [productname] ASC"
            con.Open()
    ...
    Private Sub LoadTestDev()
        Try
            ...
            Dim cmd As New SqlCommand
            cmd.Connection = con
            cmd.CommandText = "select DISTINCT(test) from trdev where requestedby='" + Homepagefrdj.Label1.Text + "' union select DISTINCT(test) from trrot where requestedby='" + Homepagefrdj.Label1.Text + "' union select DISTINCT(test) from trstb where requestedby='" + Homepagefrdj.Label1.Text + "' order by [test] ASC"
            con.Open()
            Dim dr As SqlDataReader = cmd.ExecuteReader
            While dr.Read
    ...
    Public Sub LoadDateGroupWise()
        ...
        cmd2.Connection = con
        cmd2.CommandText = "select [productname],[strength],[btn],[test] from trdev where requestedby='" + Homepagefrdj.Label1.Text + "' group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trrot where requestedby='" + Homepagefrdj.Label1.Text + "' group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trstb where requestedby='" + Homepagefrdj.Label1.Text + "' group by [productname],[strength],[btn],[test]"
    ...
    Private Sub GunaGradientButton3_Click(sender As Object, e As EventArgs) Handles GunaGradientButton3.Click
        If DataGridView1.SelectedCells.Count > 0 Then
            Dim form As New detailviewtrstatus
    ...
    Private Sub Filterdata1(ValueTosearch As String)
        Try
            If con.State = ConnectionState.Open Then con.Close()
            Dim cmd As New SqlCommand("select [productname],[strength],[btn],[test] from trdev where requestedby='" + Homepagefrdj.Label1.Text + "' and ([btn] like '%" & ValueTosearch & "%' or [productcode] like '%" & ValueTosearch & "%' or [trno] like '%" & ValueTosearch & "%') group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trrot where requestedby='" + Homepagefrdj.Label1.Text + "' and ([atrissueno] like '%" & ValueTosearch & "%' or [productcode] like '%" & ValueTosearch & "%' or [trno] like '%" & ValueTosearch & "%') group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trstb where requestedby='" + Homepagefrdj.Label1.Text + "' and ([atrissueno] like '%" & ValueTosearch & "%' or [productcode] like '%" & ValueTosearch & "%' or [trno] like '%" & ValueTosearch & "%') group by [productname],[strength],[btn],[test]")
            cmd.Connection = con
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        Try
            If ComboBox2.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [productname],[strength],[btn],[test] from trdev where requestedby='" + Homepagefrdj.Label1.Text + "' and [productname] = '" + ComboBox1.Text + "' group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trrot where requestedby='" + Homepagefrdj.Label1.Text + "' and [productname] = '" + ComboBox1.Text + "' group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trstb where requestedby='" + Homepagefrdj.Label1.Text + "' and [productname] = '" + ComboBox1.Text + "' group by [productname],[strength],[btn],[test]")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox2.Text <> "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [productname],[strength],[btn],[test] from trdev where requestedby='" + Homepagefrdj.Label1.Text + "' and [productname] = '" + ComboBox1.Text + "' and [test]='" + ComboBox2.Text + "' group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trrot where requestedby='" + Homepagefrdj.Label1.Text + "' and [productname] = '" + ComboBox1.Text + "' and [test]='" + ComboBox2.Text + "' group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trstb where requestedby='" + Homepagefrdj.Label1.Text + "' and [productname] = '" + ComboBox1.Text + "' and [test]='" + ComboBox2.Text + "' group by [productname],[strength],[btn],[test]")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub ComboBox2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox2.SelectedIndexChanged
        ...
        Try
            If ComboBox1.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [productname],[strength],[btn],[test] from trdev where requestedby='" + Homepagefrdj.Label1.Text + "' and [test] = '" + ComboBox2.Text + "' group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trrot where requestedby='" + Homepagefrdj.Label1.Text + "' and [test] = '" + ComboBox2.Text + "' group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trstb where requestedby='" + Homepagefrdj.Label1.Text + "' and [test] = '" + ComboBox2.Text + "' group by [productname],[strength],[btn],[test]")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        ElseIf ComboBox3.Text = "Intimation" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [productname],[strength],[btn],[test] from trdev where requestedby='" + Homepagefrdj.Label1.Text + "' and requestdate between @fromdate and @todate group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trrot where requestedby='" + Homepagefrdj.Label1.Text + "' and requestdate between @fromdate and @todate group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trstb where requestedby='" + Homepagefrdj.Label1.Text + "' and requestdate between @fromdate and @todate group by [productname],[strength],[btn],[test]")
                cmd.Connection = con
        ...
        ElseIf ComboBox3.Text = "Cancelled" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [productname],[strength],[btn],[test] from trdev where requestedby='" + Homepagefrdj.Label1.Text + "' and cancelleddate IS NOT NULL and cancelleddate between @fromdate and @todate group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trrot where requestedby='" + Homepagefrdj.Label1.Text + "' and cancelleddate IS NOT NULL and cancelleddate between @fromdate and @todate group by [productname],[strength],[btn],[test] union select [productname],[strength],[btn],[test] from trstb where requestedby='" + Homepagefrdj.Label1.Text + "' and cancelleddate IS NOT NULL and cancelleddate between @fromdate and @todate group by [productname],[strength],[btn],[test]")
                cmd.Connection = con
                cmd.Parameters.AddWithValue("@fromdate", SqlDbType.Date).Value = DateTimePicker1.Value.Date
                cmd.Parameters.AddWithValue("@todate", SqlDbType.Date).Value = DateTimePicker2.Value.Date
                Dim adapter1 As New SqlDataAdapter(cmd)
    ...
    Private Sub ComboBox4_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox4.SelectedIndexChanged
        ...
        If ComboBox4.Text = "Development" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [productname],[strength],[btn],[test] from trdev where requestedby='" + Homepagefrdj.Label1.Text + "' group by [productname],[strength],[btn],[test]")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
        ...
        ElseIf ComboBox4.Text = "Routine" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [productname],[strength],[btn],[test] from trrot where requestedby='" + Homepagefrdj.Label1.Text + "' group by [productname],[strength],[btn],[test]")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
        ...
        ElseIf ComboBox4.Text = "Stability" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [productname],[strength],[btn],[test] from trstb where requestedby='" + Homepagefrdj.Label1.Text + "' group by [productname],[strength],[btn],[test]")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
