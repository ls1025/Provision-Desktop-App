...
Public Class addtrstb
    Dim da As New SqlDataAdapter()
    Private Sub addtrstb_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub Loadtest()
        Try
            ...
            con.Open()
            Dim qry As String
            qry = "select Test from productlistdoc where proname='" + TextBox2.Text + "' and market='" + TextBox4.Text + "' and stpno IS NOT NULL"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            ElseIf DateTimePicker1.Text = " " And GunaRadioButton1.Checked = False Then
                MsgBox("Select Manufacturing date, Tick NA if Not Applicable", vbCritical)
            ElseIf DateTimePicker2.Text = " " And GunaRadioButton2.Checked = False Then
            ...
            ElseIf ComboBox2.Text = "1" Then
                ...
                Else
                    ...
                    firsttest()
                    Dim f1 As Viewintimationstb = DirectCast(Me.Owner, Viewintimationstb)
    ...
    Private Sub GetGroupleadername()
        If con.State = ConnectionState.Open Then con.Close()
        Dim qry1 As String
        qry1 = "select reportto from users where fullname='" + Homepagefrdj.Label1.Text + "'"
    ...
    Private Sub GunaRadioButton1_CheckedChanged(sender As Object, e As EventArgs) Handles GunaRadioButton1.CheckedChanged
        If GunaRadioButton1.Checked = True Then
            DateTimePicker1.Format = DateTimePickerFormat.Custom
            DateTimePicker1.CustomFormat = " "
        ElseIf GunaRadioButton1.Checked = False Then
            DateTimePicker1.Format = DateTimePickerFormat.Custom
            DateTimePicker1.CustomFormat = "MM/yyyy"
        End If
    ...
    Private Sub GunaRadioButton2_CheckedChanged(sender As Object, e As EventArgs) Handles GunaRadioButton2.CheckedChanged
        If GunaRadioButton2.Checked = True Then
            DateTimePicker2.Format = DateTimePickerFormat.Custom
            DateTimePicker2.CustomFormat = " "
        ElseIf GunaRadioButton2.Checked = False Then
            DateTimePicker2.Format = DateTimePickerFormat.Custom
            DateTimePicker2.CustomFormat = "MM/yyyy"
        End If
    End Sub
