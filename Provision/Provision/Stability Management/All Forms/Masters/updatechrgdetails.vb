...
Public Class updatechrgdetails
    ...
    Private Sub LoadDetails()
        Try
            ...
            'Period
            Label4.Text = table.Rows(0)(9).ToString()
            'Withdrawal date
            ...
            'Total Sample Qty
            TextBox7.Text = table.Rows(0)(15).ToString()
            'Available Sample Qty
            TextBox8.Text = table.Rows(0)(16).ToString()
            'Added By
            Label6.Text = table.Rows(0)(17).ToString()
            'Added On
            If table.Rows(0)(18).ToString = "" Then
                Label7.Text = ""
            Else
                Dim AddedOn As Date = Date.ParseExact(table.Rows(0)(18), "dd/MM/yyyy", System.Globalization.DateTimeFormatInfo.InvariantInfo)
                Label7.Text = AddedOn
            End If
        ...
        If result = DialogResult.Yes Then
            Try
                ...
                If TextBox7.Text = "" Then
                    If con.State = ConnectionState.Open Then con.Close()
                    Dim cmd As New OleDbCommand("update plnr set [cndn]='" + TextBox1.Text + "',[btn]='" + TextBox2.Text + "',[pctyp]='" + TextBox4.Text + "',[pccnt]='" + TextBox5.Text + "',[chrgbox]='" + TextBox6.Text + "',[ptn]='" + TextBox3.Text + "', where [ID]= " & Label1.Text & "", con)
                    con.Open()
                    cmd.ExecuteNonQuery()
                    con.Close()
                ElseIf TextBox8.Text = "" Then
                    If con.State = ConnectionState.Open Then con.Close()
                    Dim cmd As New OleDbCommand("update plnr set [cndn]='" + TextBox1.Text + "',[btn]='" + TextBox2.Text + "',[pctyp]='" + TextBox4.Text + "',[pccnt]='" + TextBox5.Text + "',[chrgbox]='" + TextBox6.Text + "',[ptn]='" + TextBox3.Text + "',[availsampleqty]='" + TextBox8.Text + "' where [ID]= " & Label1.Text & "", con)
                    con.Open()
                    cmd.ExecuteNonQuery()
                    con.Close()
                Else
                    If con.State = ConnectionState.Open Then con.Close()
                    Dim cmd As New OleDbCommand("update plnr set [cndn]='" + TextBox1.Text + "',[btn]='" + TextBox2.Text + "',[pctyp]='" + TextBox4.Text + "',[pccnt]='" + TextBox5.Text + "',[chrgbox]='" + TextBox6.Text + "',[ptn]='" + TextBox3.Text + "',[totalsampleqty]='" + TextBox7.Text + "',[availsampleqty]='" + TextBox8.Text + "' where [ID]= " & Label1.Text & "", con)
                    con.Open()
                    cmd.ExecuteNonQuery()
                    con.Close()
                End If
