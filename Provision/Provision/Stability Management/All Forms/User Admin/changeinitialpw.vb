...
Public Class changeinitialpw
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            If con.State = ConnectionState.Open Then con.Close()
            Dim cmd As New OleDbCommand("update users set [status]='Active', [password]='" + TextBox2.Text + "' where username='" + login.TextBox1.Text + "'", con)
            con.Open()
            cmd.ExecuteNonQuery()
            con.Close()
    ...
    Private Sub changeinitialpw_Load(sender As Object, e As EventArgs) Handles MyBase.Load
