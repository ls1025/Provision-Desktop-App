...
Public Class viewlnbmaster
    ...
    Private Sub viewlnbmaster_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadProductMaster()
    End Sub
    ...
    Private Sub filterdata1(ValueTosearch As String)
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "Select procode,proname,strength,market,lnb from productmaster where [proname] like '%" & ValueTosearch & "%' or [procode] like '%" & ValueTosearch & "%' or [market] like '%" & ValueTosearch & "%' and [productstatus]='Active' Group by procode,proname,strength,market,lnb order by proname ASC"
            con.Open()
            ...
            While dr.Read
                ...
                If dr.Item("lnb").ToString = "Yes" Then
                ...
                ElseIf dr.Item("lnb").ToString = "No" Then
                ...
                pic.Tag = dr.Item("procode").ToString
    ...
    Public Sub LoadProductMaster()
        Try
            ...
            Dim cmd As New SqlCommand
            cmd.Connection = con
            cmd.CommandText = "Select procode,proname,strength,market,lnb from productmaster where [productstatus]='Active' Group by procode,proname,strength,market,lnb order by proname ASC"
            con.Open()
            Dim dr As SqlDataReader = cmd.ExecuteReader
    ...
    Private Sub ViewProductDetails(sender As Object, e As EventArgs)
        ...
        Dim form As New viewlnbdetails
        form.Label1.Text = sender.Text.ToString
