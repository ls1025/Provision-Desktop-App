...
Imports SautinSoft
Imports System.IO
Public Class viewpendingtrrot
    Dim da As New SqlDataAdapter()

    Private Sub viewpendingtrrot_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Public Sub LoadIntimationDev()
        Try
            ...
            Dim cmd As New SqlCommand("Select [ID],[productcode],[strength],[btn],[trno],[requestedby],[requestdate],[Status] from trrot where productname='" + Label1.Text + "' and test='" + Label2.Text + "' and (Status='New TR' or Status='TR Printed' or Status='ATR Issued' or Status='Data Sent to DQA' or Status='Released') order by [trno] DESC")
