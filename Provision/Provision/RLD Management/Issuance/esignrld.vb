...
Public Class esignrld

    Dim cmd As SqlCommand
    Dim cmd1 As SqlCommand
    Dim cmd2 As SqlCommand
    Dim cmd3 As SqlCommand
    Private Sub esignrld_Load(sender As Object, e As EventArgs) Handles MyBase.Load
                        ...
                        ElseIf password = TextBox2.Text Then
                            Try
                                ...
                                If type = "FRD Scientist" Then
                                    ...
                                    Dim f1 As issuerldsample = DirectCast(Me.Owner, issuerldsample)
                                    f1.Label4.Text = fullname
                                    Me.Close()
                                ...
                                Else
                                    MsgBox("Authentication Failue as this user is not allowed to receive RLD samples", vbCritical)
                                    Me.Close()
                                End If
