...
Imports iTextSharp
Imports System.IO
Public Class viewstabilitysampledetails
    Dim da As New SqlDataAdapter()
    Dim dt As New DataTable()
    Private Sub viewstabilitysampledetails_Load(sender As Object, e As EventArgs) Handles Me.Load
        ' changecolor()
    ...
    Public Sub loadplnr()
        Try
            ...
            Dim cmd As New SqlCommand
            cmd.Connection = con
            da = New SqlDataAdapter("Select proname,strength,btn,ptn,pctyp,chrgdate from plnr group by proname,strength,btn,ptn,pctyp,chrgdate order by [chrgdate] DESC", con)
    ...
    Private Sub filterdata1(ValueTosearch As String)
        Try
            If con.State = ConnectionState.Open Then con.Close()
            Dim cmd As New SqlCommand("Select proname,strength,btn,ptn,pctyp,chrgdate from plnr where ([ptn] like '%" & ValueTosearch & "%' or [pctyp] like '%" & ValueTosearch & "%') group by proname,strength,btn,ptn,pctyp,chrgdate order by [chrgdate] DESC")
            cmd.Connection = con
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Try
            If ComboBox2.Text = "" And ComboBox3.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select proname,strength,btn,ptn,pctyp,chrgdate from plnr where [proname] = '" + ComboBox1.Text + "' group by proname,strength,btn,ptn,pctyp,chrgdate order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox2.Text <> "" And ComboBox3.Text <> "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select proname,strength,btn,ptn,pctyp,chrgdate from plnr where [proname] = '" + ComboBox1.Text + "' and [btn]='" + ComboBox2.Text + "' and [cndn]='" + ComboBox3.Text + "' group by proname,strength,btn,ptn,pctyp,chrgdate order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox2.Text <> "" And ComboBox3.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select proname,strength,btn,ptn,pctyp,chrgdate from plnr where [proname] = '" + ComboBox1.Text + "' and [btn]='" + ComboBox2.Text + "' group by proname,strength,btn,ptn,pctyp,chrgdate order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox2.Text = "" And ComboBox3.Text <> "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select proname,strength,btn,ptn,pctyp,chrgdate from plnr where [proname] = '" + ComboBox1.Text + "' and [cndn]='" + ComboBox3.Text + "' group by proname,strength,btn,ptn,pctyp,chrgdate order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub ComboBox2_TextChanged(sender As Object, e As EventArgs) Handles ComboBox2.SelectedIndexChanged
        Try
            If ComboBox1.Text = "" And ComboBox3.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select proname,strength,btn,ptn,pctyp,chrgdate from plnr where [btn] = '" + ComboBox2.Text + "' group by proname,strength,btn,ptn,pctyp,chrgdate order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox1.Text = "" And ComboBox3.Text <> "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select proname,strength,btn,ptn,pctyp,chrgdate from plnr where [btn] = '" + ComboBox2.Text + "' and [cndn]='" + ComboBox3.Text + "' group by proname,strength,btn,ptn,pctyp,chrgdate order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub ComboBox3_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox3.SelectedIndexChanged
        Try
            If ComboBox1.Text = "" And ComboBox2.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select proname,strength,btn,ptn,pctyp,chrgdate from plnr where [cndn] = '" + ComboBox3.Text + "' group by proname,strength,btn,ptn,pctyp,chrgdate order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        ElseIf ComboBox4.Text = "Charged" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select proname,strength,btn,ptn,pctyp,chrgdate from plnr where chrgdate between @fromdate and @todate group by proname,strength,btn,ptn,pctyp,chrgdate order by [chrgdate] ASC")
        ...
        ElseIf ComboBox4.Text = "Withdrawal Date" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select proname,strength,btn,ptn,pctyp,chrgdate from plnr where podate between @fromdate and @todate group by proname,strength,btn,ptn,pctyp,chrgdate order by [chrgdate] ASC")
                cmd.Connection = con
                cmd.Parameters.AddWithValue("@fromdate", SqlDbType.Date).Value = DateTimePicker1.Value.Date
                cmd.Parameters.AddWithValue("@todate", SqlDbType.Date).Value = DateTimePicker2.Value.Date
        ...
        ElseIf ComboBox4.Text = "Withdrawal On" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select proname,strength,btn,ptn,pctyp,chrgdate from plnr where actpodate between @fromdate and @todate group by proname,strength,btn,ptn,pctyp,chrgdate order by [chrgdate] ASC")
                cmd.Connection = con
                cmd.Parameters.AddWithValue("@fromdate", SqlDbType.Date).Value = DateTimePicker1.Value.Date
                cmd.Parameters.AddWithValue("@todate", SqlDbType.Date).Value = DateTimePicker2.Value.Date
                Dim adapter1 As New SqlDataAdapter(cmd)
    ...
    Private Sub GunaGradientButton1_Click(sender As Object, e As EventArgs) Handles GunaGradientButton1.Click
        Dim form As New stabilitycalender
        form.ShowDialog()
    End Sub
    Private Sub GunaGradientButton2_Click(sender As Object, e As EventArgs) Handles GunaGradientButton2.Click
        If DataGridView1.SelectedCells.Count > 0 Then
            Dim form As New detailviewstabilitysample
