...
Imports iTextSharp
Imports System.IO
Public Class viewrldmasterdata
    Dim da As New SqlDataAdapter()
    Dim dt As New DataTable()
    Private Sub viewrldmasterdata_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Public Sub LoadRLDDetails()
        Try
            ...
            Dim cmd As New SqlCommand
            cmd.Connection = con
            da = New SqlDataAdapter("Select id,proname,strength,brand,btn,receivedqty,balanceqty,strlocation from rld_master order by proname ASC", con)
    ...
    Private Sub filterdata1(ValueTosearch As String)
        Try
            If con.State = ConnectionState.Open Then con.Close()
            Dim cmd As New SqlCommand("Select id,proname,strength,brand,btn,receivedqty,balanceqty,strlocation from rld_master where ([brand] like '%" & ValueTosearch & "%' or [manfact] like '%" & ValueTosearch & "%' or [strlocation] like '%" & ValueTosearch & "%') order by [proname] ASC")
            cmd.Connection = con
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        Try
            If ComboBox2.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select id,proname,strength,brand,btn,receivedqty,balanceqty,strlocation from rld_master where [proname] = '" + ComboBox1.Text + "' order by [proname] ASC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox2.Text <> "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select id,proname,strength,brand,btn,receivedqty,balanceqty,strlocation from rld_master where [proname] = '" + ComboBox1.Text + "' and [cntry]='" + ComboBox2.Text + "' order by [proname] ASC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub ComboBox2_TextChanged(sender As Object, e As EventArgs) Handles ComboBox2.SelectedIndexChanged
        Try
            If ComboBox1.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select id,proname,strength,brand,btn,receivedqty,balanceqty,strlocation from rld_master where actpodate IS NULL and [cntry] = '" + ComboBox2.Text + "' order by [proname] ASC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If ComboBox4.Text = "Recieved" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select id,proname,strength,brand,btn,receivedqty,balanceqty,strlocation from rld_master where receiptdate between @fromdate and @todate order by [proname] ASC")
        ...
        ElseIf ComboBox4.Text = "Expired" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select id,proname,strength,brand,btn,receivedqty,balanceqty,strlocation from rld_master where expdate<GetDate() order by [proname] ASC")
                cmd.Connection = con
                cmd.Parameters.AddWithValue("@fromdate", SqlDbType.Date).Value = DateTimePicker1.Value.Date
                cmd.Parameters.AddWithValue("@todate", SqlDbType.Date).Value = DateTimePicker2.Value.Date
    ...
    Private Sub GunaGradientButton1_Click(sender As Object, e As EventArgs) Handles GunaGradientButton1.Click
        Dim form As New addrld
        form.Owner = Me
        form.ShowDialog()
    End Sub
    Private Sub GunaGradientButton2_Click(sender As Object, e As EventArgs) Handles GunaGradientButton2.Click
        If DataGridView1.SelectedCells.Count > 0 Then
            Dim form As New issuerldsample
