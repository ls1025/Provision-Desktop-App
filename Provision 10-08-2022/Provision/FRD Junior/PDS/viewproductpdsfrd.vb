...
Public Class viewproductpdsfrd
    ...
    Private Sub viewproductpdsfrd_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        loadData()
    End Sub
    ...
    Private Sub filterdata1(ValueTosearch As String)
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "Select proname,market from productlistpds where [proname] like '%" & ValueTosearch & "%' or [market] like '%" & ValueTosearch & "%' and [status]='Active' Group by proname,market"
            con.Open()
            ...
            While dr.Read
                ...
                AddHandler pic.Click, AddressOf viewpds
    ...
    Public Sub loadData()
        Try
            ...
            Dim cmd As New SqlCommand
            cmd.Connection = con
            cmd.CommandText = "Select proname,market from productlistpds where [status]='Active' Group by proname,market order by proname ASC"
            con.Open()
            Dim dr As SqlDataReader = cmd.ExecuteReader
        ...
        End Try
    End Sub
    Private Sub viewpds(sender As Object, e As EventArgs)

        Dim form As New viewpdsdetailsfrd
