...
Imports SautinSoft
Imports System.IO
Public Class viewtrstatusfrdj
    Dim da As New SqlDataAdapter()

    Private Sub viewtrstatusfrdj_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub ReportOpenAudit()
        If DataGridView1.SelectedCells.Count > 0 Then
            ...
            Dim cmd2 As New SqlCommand
            cmd2.Connection = con
            cmd2.CommandText = "insert into  viewtraudit(trno,viewedby,vieweddate) values('" + DataGridView1.SelectedCells(6).Value.ToString + "','" + Homepagefrdj.Label1.Text + "',@vieweddate)"
