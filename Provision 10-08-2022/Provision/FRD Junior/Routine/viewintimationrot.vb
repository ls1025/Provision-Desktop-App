...
Imports iTextSharp
Imports System.IO
Public Class Viewintimationrot
    Dim da As New SqlDataAdapter()

    Private Sub viewintimationrot_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub GunaGradientButton1_Click(sender As Object, e As EventArgs) Handles GunaGradientButton1.Click
        Dim form As New addtrrot
        form.Owner = Me
        form.ShowDialog()
    End Sub

    Private Sub GunaGradientButton2_Click(sender As Object, e As EventArgs) Handles GunaGradientButton2.Click
        Dim form As New viewcancelintrot
        form.Owner = Me
        form.ShowDialog()
    End Sub
