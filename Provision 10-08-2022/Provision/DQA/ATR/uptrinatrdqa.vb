...
Public Class uptrinatrdqa

    Dim cmd As SqlCommand
    Dim cmd1 As SqlCommand
    Dim cmd2 As SqlCommand

    Private Sub uptrinatrdqa_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        ElseIf TextBox4.Text = "" Then
            ...
            ' ElseIf TextBox5.Text = "" Or TextBox5.Text <> "HP LaserJet 1020" Then
        ...
        Else
            ...
            If result = DialogResult.Yes Then
                ...
                For Each item In ListBox1.Items
                    ...
                    cmd1.Connection = con
                    cmd1.CommandText = "insert into atrissuelog (proname,test,trno,atrno,atrissueno,issuedby,issueddate,remarks) values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + item + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + homepagedqa.Label1.Text + "',@issueddate,'" + GunaTextBox1.Text + "')"
                    ...
                    cmd2.Connection = con
                    cmd2.CommandText = "update trdev set lnbno='NA',atrno='" + TextBox3.Text + "',atrissueno='" + TextBox4.Text + "',atrissuedby='" + homepagedqa.Label1.Text + "',atrissueddate=@atrissueddate,Status='ATR Issued' where trno='" + item + "'"
                    ...
                    cmd4.Connection = con
                    cmd4.CommandText = "update trrot set lnbno='NA',atrno='" + TextBox3.Text + "',atrissueno='" + TextBox4.Text + "',atrissuedby='" + homepagedqa.Label1.Text + "',atrissueddate=@atrissueddate,Status='ATR Issued' where trno='" + item + "'"
                    ...
                    cmd5.Connection = con
                    cmd5.CommandText = "update trstb set lnbno='NA',atrno='" + TextBox3.Text + "',atrissueno='" + TextBox4.Text + "',atrissuedby='" + homepagedqa.Label1.Text + "',atrissueddate=@atrissueddate,Status='ATR Issued' where trno='" + item + "'"
