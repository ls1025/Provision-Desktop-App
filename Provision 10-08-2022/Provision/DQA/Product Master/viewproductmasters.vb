...
Public Class viewproductmasters
    ...
    Private Sub viewproductmasters_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadProductMaster()
    End Sub
    ...
    Private Sub ViewProductDetails(sender As Object, e As EventArgs)
        Dim form As New viewproductdetailsdqa
