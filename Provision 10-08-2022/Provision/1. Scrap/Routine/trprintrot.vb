...
Public Class trprintrot
    Dim cmd As SqlCommand
    Dim cmd1 As SqlCommand
    Dim cmd2 As SqlCommand
    Dim cmd3 As SqlCommand
    'Private pageNo As Integer = 1
    Private Sub trprintrot_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Me.AutoScroll = True
        'Label1.Hide()
        Label2.Hide()
        PictureBox1.Hide()
    ...
    Private Sub PrintDocument1_PrintPage(sender As System.Object, e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        Try
            ...
            e.Graphics.DrawString("Recieved By :", ReportFont1, Brushes.Black, 290, 550)
    ...
    Private Sub Button46_Click(sender As System.Object, e As System.EventArgs)
        Me.Close()
    End Sub
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            If d = Windows.Forms.DialogResult.OK Then
                ...
                'End Using
                Me.Close()
                'dashdevfrdj.diplaytredev()
                'dashdevfrdh.displaycounttrdevself()
            End If
