...
Public Class viewlicensedetails
    Private WithEvents pic As New Guna.UI.WinForms.GunaGradientButton
    Private WithEvents conutlabel As New Label
    Private Sub viewlicensedetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub LoadDocumentDetails()
        Try
            ...
            Dim sql As String
            sql = "Select [id],[market],[licensetype],[applyform],[docfromfrd],[doctoconsultant],[appliedby],[appliedon],[licstatus] from productlicense where [proname]='" + Label1.Text + "' and [strength]='" + Label2.Text + "' order by [id] DESC"
