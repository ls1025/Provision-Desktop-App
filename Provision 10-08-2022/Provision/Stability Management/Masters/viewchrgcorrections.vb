...
Public Class viewchrgcorrections
    ...
    Public Sub LoadChargingDetails()
        Try
            ...
            Dim cmd As New SqlCommand
            cmd.Connection = con
            da = New SqlDataAdapter("Select [ID],[proname],[cndn],[btn],[chrgdate],[ptn],[sch] from plnr where actpodate IS NULL order by [chrgdate] DESC", con)
    ...
    Private Sub filterdata1(ValueTosearch As String)
        Try
            If con.State = ConnectionState.Open Then con.Close()
            Dim cmd As New SqlCommand("Select [ID],[proname],[cndn],[btn],[chrgdate],[ptn],[sch] from plnr where where actpodate IS NULL and ([sch] like '%" & ValueTosearch & "%' or [ptn] like '%" & ValueTosearch & "%' or [pctyp] like '%" & ValueTosearch & "%') order by [chrgdate] DESC")
            cmd.Connection = con
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Try
            If ComboBox2.Text = "" And ComboBox3.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[proname],[cndn],[btn],[chrgdate],[ptn],[sch] from plnr where actpodate IS NULL and [proname] = '" + ComboBox1.Text + "' order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox2.Text <> "" And ComboBox3.Text <> "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[proname],[cndn],[btn],[chrgdate],[ptn],[sch] from plnr where actpodate IS NULL and [proname] = '" + ComboBox1.Text + "' and [btn]='" + ComboBox2.Text + "' and [cndn]='" + ComboBox3.Text + "' order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox2.Text <> "" And ComboBox3.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[proname],[cndn],[btn],[chrgdate],[ptn],[sch] from plnr where actpodate IS NULL and [proname] = '" + ComboBox1.Text + "' and [btn]='" + ComboBox2.Text + "' order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox2.Text = "" And ComboBox3.Text <> "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[proname],[cndn],[btn],[chrgdate],[ptn],[sch] from plnr where actpodate IS NULL and [proname] = '" + ComboBox1.Text + "' and [cndn]='" + ComboBox3.Text + "' order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub ComboBox2_TextChanged(sender As Object, e As EventArgs) Handles ComboBox2.SelectedIndexChanged
        Try
            If ComboBox1.Text = "" And ComboBox3.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[proname],[cndn],[btn],[chrgdate],[ptn],[sch] from plnr where actpodate IS NULL and [btn] = '" + ComboBox2.Text + "' order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox1.Text = "" And ComboBox3.Text <> "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[proname],[cndn],[btn],[chrgdate],[ptn],[sch] from plnr where actpodate IS NULL and [btn] = '" + ComboBox2.Text + "' and [cndn]='" + ComboBox3.Text + "' order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub ComboBox3_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox3.SelectedIndexChanged
        Try
            If ComboBox1.Text = "" And ComboBox2.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[proname],[cndn],[btn],[chrgdate],[ptn],[sch] from plnr where actpodate IS NULL and [cndn] = '" + ComboBox3.Text + "' order by [chrgdate] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        ElseIf ComboBox4.Text = "Charged" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[proname],[cndn],[btn],[chrgdate],[ptn],[sch] from plnr where actpodate IS NULL and chrgdate between @fromdate and @todate order by [chrgdate] ASC")
        ...
        ElseIf ComboBox4.Text = "Withdrawal Date" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[proname],[cndn],[btn],[chrgdate],[ptn],[sch] from plnr where actpodate IS NULL and podate between @fromdate and @todate order by [podate] ASC")
                cmd.Parameters.AddWithValue("@fromdate", SqlDbType.Date).Value = DateTimePicker1.Value.Date
                cmd.Parameters.AddWithValue("@todate", SqlDbType.Date).Value = DateTimePicker2.Value.Date
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
        ...
        ElseIf ComboBox4.Text = "Withdrawal On" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [ID],[proname],[cndn],[btn],[chrgdate],[ptn],[sch] from plnr where actpodate IS NULL and actpodate between @fromdate and @todate order by [actpodate] ASC")
                cmd.Parameters.AddWithValue("@fromdate", SqlDbType.Date).Value = DateTimePicker1.Value.Date
                cmd.Parameters.AddWithValue("@todate", SqlDbType.Date).Value = DateTimePicker2.Value.Date
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
