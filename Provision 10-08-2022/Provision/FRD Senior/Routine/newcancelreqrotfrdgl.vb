...
Public Class newcancelreqrotfrdgl
    Private Sub newcancelreqrotfrdgl_Load(sender As Object, e As EventArgs) Handles MyBase.Load
                ...
                For i As Integer = 0 To CheckedListBox1.CheckedItems.Count - 1
                    ...
                    Try
                        For Each item In CheckedListBox1.Items
                            ...
                            cmd1.Connection = con
                            cmd1.CommandText = "update trrot set creqstatus='Cancelled',Status='Cancelled',creqby='NA',cancelledby='" + Homepagefrdgl.Label1.Text + "',cancelleddate=@cancelleddate where trno='" + CheckedListBox1.CheckedItems(i) + "'"
                    ...
                    End Try
                Next
                Dim f1 As viewcancelintrotfrdgl = DirectCast(Me.Owner, viewcancelintrotfrdgl)
