...
Public Class newcancelreqstbfrdgl
    Private Sub newcancelreqstbfrdgl_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GunaGradientButton1_Click(sender As Object, e As EventArgs) Handles GunaGradientButton1.Click
        ...
        Else
            ...
            If result = DialogResult.Yes Then
                For i As Integer = 0 To CheckedListBox1.CheckedItems.Count - 1
                    ...
                    Try
                        For Each item In CheckedListBox1.Items
                            ...
                            cmd1.Connection = con
                            cmd1.CommandText = "update trstb set creqstatus='Cancelled',Status='Cancelled',creqby='NA',cancelledby='" + Homepagefrdgl.Label1.Text + "',cancelleddate=@cancelleddate where trno='" + CheckedListBox1.CheckedItems(i) + "'"
                ...
                Next
                Dim f1 As viewcancelintstbfrdgl = DirectCast(Me.Owner, viewcancelintstbfrdgl)
