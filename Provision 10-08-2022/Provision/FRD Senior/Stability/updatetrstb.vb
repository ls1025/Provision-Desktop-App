...
Public Class updatetrstb
    Private Sub updatetrstb_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            If Label31.Text = "New TR" Or Label31.Text = "TR Printed" Or Label31.Text = "ATR Issued" Or Label31.Text = "Data Sent to DQA" Then
                ...
                cmd1.Connection = con
                cmd1.CommandText = "update trstb set label='" + TextBox1.Text + "',btn='" + TextBox2.Text + "',btsize='" + TextBox3.Text + "',mfgdate='" + TextBox4.Text + "',expdate='" + TextBox5.Text + "',sampleqty='" + TextBox6.Text + "',pack='" + TextBox7.Text + "',cndn='" + ComboBox1.Text + "',period='" + TextBox8.Text + "',testdetails='" + TextBox9.Text + "',remarks='" + TextBox10.Text + "' where trno='" + Label1.Text + "'"
