...
Public Class Homepagefrdgl
    ...
    End Sub
    Private Sub Homepagefrdgl_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub GunaAdvenceButton1_Click(sender As Object, e As EventArgs) Handles GunaAdvenceButton1.Click
        ...
        OpenChildForm(New viewintimationdevfrdgl())
    End Sub
    ...
    Private Sub GunaAdvenceButton2_Click(sender As Object, e As EventArgs) Handles GunaAdvenceButton2.Click
        ...
        OpenChildForm(New viewintimationrotfrdgl())
    End Sub
    ...
    Private Sub GunaAdvenceButton3_Click(sender As Object, e As EventArgs) Handles GunaAdvenceButton3.Click
        ...
        OpenChildForm(New viewintimationstbfrdgl())
    End Sub
    ...
    Private Sub GunaAdvenceButton8_Click(sender As Object, e As EventArgs) Handles GunaAdvenceButton8.Click
        Panel2.Hide()
        Panel5.Hide()
        GunaLabel1.Text = AButton4.Text + "-" + GunaAdvenceButton8.Text
    ...
    Private Sub AButto5_Click(sender As Object, e As EventArgs) Handles AButton5.Click
        ...
        OpenChildForm(New viewtrstatusfrdgl())
    End Sub
