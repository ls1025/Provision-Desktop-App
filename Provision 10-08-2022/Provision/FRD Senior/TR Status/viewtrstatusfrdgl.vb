...
Public Class viewtrstatusfrdgl
    ...
    Public Sub LoadDate()
        ...
        cmd2.Connection = con
        cmd2.CommandText = "select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trdev union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trrot union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trstb order by [trno] DESC"
    ...
    Private Sub Filterdata1(ValueTosearch As String)
        Try
            If con.State = ConnectionState.Open Then con.Close()
            Dim cmd As New SqlCommand("select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trdev where ([btn] like '%" & ValueTosearch & "%' or [productcode] like '%" & ValueTosearch & "%' or [trno] like '%" & ValueTosearch & "%' or [Status] like '%" & ValueTosearch & "%') union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trrot where ([btn] like '%" & ValueTosearch & "%' or [productcode] like '%" & ValueTosearch & "%' or [trno] like '%" & ValueTosearch & "%' or [Status] like '%" & ValueTosearch & "%') union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trstb where ([btn] like '%" & ValueTosearch & "%' or [productcode] like '%" & ValueTosearch & "%' or [trno] like '%" & ValueTosearch & "%' or [Status] like '%" & ValueTosearch & "%') order by [trno] DESC")
            cmd.Connection = con
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        Try
            If ComboBox2.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trdev where [productname] = '" + ComboBox1.Text + "' union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trrot where [productname] = '" + ComboBox1.Text + "' union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trstb where [productname] = '" + ComboBox1.Text + "' order by [trno] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            ElseIf ComboBox2.Text <> "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trdev where [productname] = '" + ComboBox1.Text + "' and [test]='" + ComboBox2.Text + "' union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trrot where [productname] = '" + ComboBox1.Text + "' and [test]='" + ComboBox2.Text + "' union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trstb where [productname] = '" + ComboBox1.Text + "' and [test]='" + ComboBox2.Text + "' order by [trno] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub ComboBox2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox2.SelectedIndexChanged
        ...
        Try
            If ComboBox1.Text = "" Then
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trdev where [test] = '" + ComboBox2.Text + "' union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trrot where [test] = '" + ComboBox2.Text + "' union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trstb where [test] = '" + ComboBox2.Text + "' order by [trno] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        ElseIf ComboBox3.Text = "Intimation" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trdev where requestdate between @fromdate and @todate union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trrot where requestdate between @fromdate and @todate union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trstb where requestdate between @fromdate and @todate order by [trno] DESC")
                cmd.Connection = con
        ...
        ElseIf ComboBox3.Text = "Cancelled" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trdev where cancelleddate IS NOT NULL and cancelleddate between @fromdate and @todate union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trrot where cancelleddate IS NOT NULL and cancelleddate between @fromdate and @todate union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trstb where cancelleddate IS NOT NULL and cancelleddate between @fromdate and @todate order by [trno] DESC")
                cmd.Connection = con
                cmd.Parameters.AddWithValue("@fromdate", SqlDbType.Date).Value = DateTimePicker1.Value.Date
                cmd.Parameters.AddWithValue("@todate", SqlDbType.Date).Value = DateTimePicker2.Value.Date
                Dim adapter1 As New SqlDataAdapter(cmd)
        ...
        ElseIf ComboBox3.Text = "Released" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trdev where releaseddate IS NOT NULL and releaseddate between @fromdate and @todate union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trrot where releaseddate IS NOT NULL and releaseddate between @fromdate and @todate union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trstb where releaseddate IS NOT NULL and releaseddate between @fromdate and @todate order by [trno] DESC")
                cmd.Connection = con
                cmd.Parameters.AddWithValue("@fromdate", SqlDbType.Date).Value = DateTimePicker1.Value.Date
                cmd.Parameters.AddWithValue("@todate", SqlDbType.Date).Value = DateTimePicker2.Value.Date
                Dim adapter1 As New SqlDataAdapter(cmd)
        ...
        ElseIf ComboBox3.Text = "Data Uploaded" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trdev where datauploaddate IS NOT NULL and datauploaddate between @fromdate and @todate union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trrot where datauploaddate IS NOT NULL and datauploaddate between @fromdate and @todate union select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trstb where datauploaddate IS NOT NULL and datauploaddate between @fromdate and @todate order by [trno] DESC")
                cmd.Connection = con
                cmd.Parameters.AddWithValue("@fromdate", SqlDbType.Date).Value = DateTimePicker1.Value.Date
                cmd.Parameters.AddWithValue("@todate", SqlDbType.Date).Value = DateTimePicker2.Value.Date
                Dim adapter1 As New SqlDataAdapter(cmd)
    ...
    Private Sub ComboBox4_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox4.SelectedIndexChanged
        ...
        If ComboBox5.Text = "" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from " + trtype + " order by [trno] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            Catch ex As Exception
                MessageBox.Show(ex.Message)
            End Try
        ElseIf ComboBox5.Text = "Pending" Then
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from " + trtype + " where [Status]<>'Cancelled' and [Status]<>'Released' and [Status]<>'Data Uploaded' order by [trno] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
        ...
        Else
            Try
                If con.State = ConnectionState.Open Then con.Close()
                Dim cmd As New SqlCommand("Select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from " + trtype + " where [Status] =" + status + " order by [trno] DESC")
                cmd.Connection = con
                Dim adapter1 As New SqlDataAdapter(cmd)
                Dim table1 As New DataTable()
                DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Sub ComboBox5_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox5.SelectedIndexChanged
        ...
        If ComboBox4.Text = "" Then
            If ComboBox5.Text = "Pending" Then
                Try
                    If con.State = ConnectionState.Open Then con.Close()
                    Dim cmd As New SqlCommand("Select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trdev where [Status]<>'Cancelled' and [Status]<>'Data Uploaded' union Select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trrot where [Status]<>'Cancelled' and [Status]<>'Data Uploaded' union Select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trstb where [Status]<>'Cancelled' and [Status]<>'Data Uploaded' order by [trno] DESC")
                    cmd.Connection = con
                    Dim adapter1 As New SqlDataAdapter(cmd)
                    Dim table1 As New DataTable()
                    DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
            ...
            Else
                Try
                    If con.State = ConnectionState.Open Then con.Close()
                    Dim cmd As New SqlCommand("Select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trdev where [Status] =" + status + " union Select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trrot where [Status] =" + status + " union Select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from trstb where [Status] =" + status + " order by [trno] DESC")
                    cmd.Connection = con
                    Dim adapter1 As New SqlDataAdapter(cmd)
                    Dim table1 As New DataTable()
                    DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
        ...
        ElseIf ComboBox4.Text <> "" Then
            If ComboBox5.Text = "Pending" Then
                Try
                    If con.State = ConnectionState.Open Then con.Close()
                    Dim cmd As New SqlCommand("Select [id],[productcode],[productname],[strength],[btn],[test],[trno],[requestedby],[requestdate],[Status] from " + trtype + " where [Status]<>'Cancelled' and [Status]<>'Data Uploaded' order by [trno] DESC")
                    cmd.Connection = con
                    Dim adapter1 As New SqlDataAdapter(cmd)
                    Dim table1 As New DataTable()
                    DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None
    ...
    Private Shared Sub OpenPDFFile(ByVal sFilePath)
        ...
        End Using
    End Sub
    Private Sub ReportOpenAudit()
        If DataGridView1.SelectedCells.Count > 0 Then
            If con.State = ConnectionState.Open Then con.Close()
            Dim cmd2 As New SqlCommand
            cmd2.Connection = con
            cmd2.CommandText = "insert into  viewtraudit(trno,viewedby,vieweddate) values('" + DataGridView1.SelectedCells(6).Value.ToString + "','" + Homepagefrdgl.Label1.Text + "',@vieweddate)"
    ...
    Private Sub GunaGradientButton4_Click(sender As Object, e As EventArgs) Handles GunaGradientButton4.Click
        If DataGridView1.SelectedCells.Count > 0 Then
            Dim form As New trviewaudit
            form.Label1.Text = DataGridView1.SelectedCells(6).Value.ToString
            form.ShowDialog()
        End If
    End Sub
End Class
