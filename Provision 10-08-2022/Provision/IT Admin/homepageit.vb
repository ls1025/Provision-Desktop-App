...
Public Class homepageit
    ...
    End Sub
    Private Sub homepageit_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub AsdasdToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AsdasdToolStripMenuItem.Click
        Dim form As New changepwit
        form.ShowDialog()
    End Sub

    Private Sub Button4_Click(sender As Object, e As EventArgs) 
        Dim myDate As String = DateTime.Now.Date.Year
        myDate = myDate.Remove(1, 2)
        MsgBox(myDate)
    End Sub
