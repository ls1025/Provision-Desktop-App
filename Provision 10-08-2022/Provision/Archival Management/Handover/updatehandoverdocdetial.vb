...
Public Class updatehandoverdocdetial
    Private Sub updatehandoverdocdetial_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        cmd3.Connection = con
        cmd3.CommandText = "update archival_master set doctype='" + ComboBox1.Text + "',catogery='" + ComboBox2.Text + "',docname='" + TextBox1.Text + "',docno='" + TextBox2.Text + "',test='" + ComboBox3.Text + "',verstatus='" + docversion_status + "',remarks='" + TextBox4.Text + "' where id='" + Label1.Text + "'"
