...
Imports System.IO
Public Class viewarchivecatogery
    ...
    Private Sub viewarchivecatogery_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Public Sub Load_Archive_Category()
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select COUNT(catogery) AS 'Total', catogery from archival_master where doctype='" + Label1.Text + "' and status='archived' group by catogery order by catogery ASC"
            con.Open()
    ...
    Private Sub View_Handover_Catogery(sender As Object, e As EventArgs)
        ...
        Dim form As New viewarchivedocdetails
        form.Owner = Me
