...
Public Class trprintdev
    Dim cmd As SqlCommand
    Dim cmd1 As SqlCommand
    Dim cmd2 As SqlCommand
    Dim cmd3 As SqlCommand
    'Private pageNo As Integer = 1
    Private Sub trprintdev_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            If Label1.Text.Contains("DT/") Then
                ...
                If d = Windows.Forms.DialogResult.OK Then
                    ...
                    cmd1.Connection = con
                    cmd1.CommandText = "update trdev set prints='" + result + "',Status='TR Printed',trprintby='" + homepageard.Label1.Text + "',trprintdate=@trprintdate where trno='" + Label1.Text + "'"
                    cmd1.Parameters.AddWithValue("@trprintdate", SqlDbType.Date).Value = DateTime.Now.Date
                    con.Open()
                ...
                If d = Windows.Forms.DialogResult.OK Then
                    ...
                    Dim cmd1 As New SqlCommand
                    cmd1.Connection = con
                    cmd1.CommandText = "update trrot set prints='" + result + "',Status='TR Printed',trprintby='" + homepageard.Label1.Text + "',trprintdate=@trprintdate where trno='" + Label1.Text + "'"
                    cmd1.Parameters.AddWithValue("@trprintdate", SqlDbType.Date).Value = DateTime.Now.Date
                    con.Open()
                    cmd1.ExecuteNonQuery()
                    con.Close()
            ...
            ElseIf Label1.Text.Contains("ST/") Then
                ...
                If d = Windows.Forms.DialogResult.OK Then
                    ...
                    Dim cmd1 As New SqlCommand
                    cmd1.Connection = con
                    cmd1.CommandText = "update trstb set prints='" + result + "',Status='TR Printed',trprintby='" + homepageard.Label1.Text + "',trprintdate=@trprintdate where trno='" + Label1.Text + "'"
                    cmd1.Parameters.AddWithValue("@trprintdate", SqlDbType.Date).Value = DateTime.Now.Date
                    con.Open()
                    cmd1.ExecuteNonQuery()
                    con.Close()
    ...
    Private Sub PrintDocument1_PrintPage(sender As System.Object, e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        Try
            ...
            e.Graphics.DrawString(proname + " " + str, ReportFont5, Brushes.Black, New System.Drawing.Rectangle(326, 210, 445, 40), StringFormat)
            ...
            e.Graphics.DrawString(btno, ReportFont5, Brushes.Black, New System.Drawing.Rectangle(100, 295, 100, 30), StringFormat)
            ...
            e.Graphics.DrawString(cond, ReportFont5, Brushes.Black, New System.Drawing.Rectangle(100, 375, 200, 30), StringFormat)

            e.Graphics.DrawString("Period :", ReportFont1, Brushes.Black, 280, 381)
            e.Graphics.DrawString(period, ReportFont5, Brushes.Black, 335, 381)
            ...
            e.Graphics.DrawString(reqby, ReportFont5, Brushes.Black, 90, 550)
            e.Graphics.DrawString("Recieved By :", ReportFont1, Brushes.Black, 285, 550)
            e.Graphics.DrawString(homepageard.Label1.Text, ReportFont5, Brushes.Black, 370, 545)
            e.Graphics.DrawString(DateTime.Now.Date, ReportFont5, Brushes.Black, 370, 560)
    ...
    Private Sub PrintDocument2_PrintPage(sender As System.Object, e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument2.PrintPage
        Try
            ...
            e.Graphics.DrawString("Period :", ReportFont1, Brushes.Black, 280, 381)
            e.Graphics.DrawString(period, ReportFont5, Brushes.Black, 355, 381)
