...
Public Class viewatrdetailsard
    Private Sub viewatrdetailsard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadTestDetails()
        Guna.UI.Lib.GraphicsHelper.DrawLineShadow(GunaPanel1, Color.Black, 50, 100, Guna.UI.WinForms.VerHorAlign.HoriziontalTop)
    End Sub
    Public Sub LoadTestDetails()
        If con.State = ConnectionState.Open Then con.Close()
        Dim cmd As New SqlCommand("select [id],[test],[atrno],[atrversion],[maxtrallowed],[atruploadedby],[atruploadeddate],[atrremarks] from productlistdoc where proname='" + Label1.Text + "' and market='" + Label2.Text + "'")
        cmd.Connection = con
