...
Public Class viewproductstpard
    Private WithEvents pic As New Guna.UI.WinForms.GunaGradientButton

    Private Sub viewproductstpard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        loadData()
    End Sub
    ...
    Private Sub filterdata1(ValueTosearch As String)
        Try
            ...
            While dr.Read
                ...
                AddHandler pic.Click, AddressOf viewstp
    ...
    Public Sub loadData()
        ...
        End Try
    End Sub
    Private Sub viewstp(sender As Object, e As EventArgs)

        Dim form As New viewstpdetailsard
